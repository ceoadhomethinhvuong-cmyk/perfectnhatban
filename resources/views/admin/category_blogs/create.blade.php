                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="name" type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Ví dụ: Kiến thức sản phẩm" required>
                        </div>
                        <div class="form-group">
                            <label for="slug">Slug</label>
                            <input id="slug" type="text" name="slug" class="form-control" value="{{ old('slug') }}" placeholder="kien-thuc-san-pham">
                        </div>
                        <div class="form-group mb-0">
                            <label for="description">Mô tả ngắn</label>
                            <textarea id="description" name="description" class="form-control" placeholder="Mô tả mục đích sử dụng của danh mục">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select id="status" name="status" class="form-control">
                                <option value="active" @selected(old('status', 'active') === 'active')>Đang hiển thị</option>
