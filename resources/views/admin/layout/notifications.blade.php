                        ...
                        <table id="bootstrap-data-table" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr class="{{$item->read_at == null ? 'read-noti' : ''}}" id="removeTr-{{ $item->id }}">
                                    ...
                                    <td><a style="color: rgb(69, 69, 69)"
                                            href="{{ route('admin.order.detailNotication', ['order_id' => $item->data['order_id'], 'noti_id' => $item->id]) }}">{{ $item->data['message'] }}</a>
                                    </td>
                                    <td class="d-flex">
                                        <a class="btn btn-primary mr-2"
                                            href="{{ route('admin.order.detailNotication', ['order_id' => $item->data['order_id'], 'noti_id' => $item->id]) }}"
